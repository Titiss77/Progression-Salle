...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 19 jan. 2026 à 10:41
...
INSERT INTO `exercice` (`id`, `idProgramme`, `libelle`, `charge`, `nbSeries`, `estActif`, `ordre`) VALUES
...
(7, '2026-01-18-000001', 'App\\Database\\Migrations\\CreateBase', 'default', 'App', 1768815672, 1),
(8, '2026-01-18-000002', 'App\\Database\\Migrations\\CreateSeances', 'default', 'App', 1768815672, 1),
(9, '2026-01-18-000003', 'App\\Database\\Migrations\\CreatePerformances', 'default', 'App', 1768815673, 1);
...
ALTER TABLE `exercice`
  ADD PRIMARY KEY (`id`),
  ADD KEY `exercice_idProgramme_foreign` (`idProgramme`);
...
--
ALTER TABLE `exercice`
  ADD CONSTRAINT `exercice_idProgramme_foreign` FOREIGN KEY (`idProgramme`) REFERENCES `programme` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
