    ...
    public function run()
    {
        ...
        $donnees = [
            'Upper' => [
                ...
                ['libelle' => 'Tirage vertical', 'charge' => 65, 'nbSeries' => 3, 'ordre' => '3'],
                ['libelle' => 'Développé incliné', 'charge' => 42.5, 'nbSeries' => 3, 'ordre' => '2'],
                ...
                ['libelle' => 'Curls biceps assis', 'charge' => 12, 'nbSeries' => 4, 'ordre' => '9'],
                ['libelle' => 'Curls marteau assis', 'charge' => 14, 'nbSeries' => 4, 'ordre' => '10'],
                ['libelle' => 'Extensions triceps bas', 'charge' => 22.5, 'nbSeries' => 4, 'ordre' => '11'],
                ['libelle' => 'Extensions triceps haut', 'charge' => 17.5, 'nbSeries' => 4, 'ordre' => '12'],
            ],
            'Lower' => [
                ['libelle' => 'Squats à la barre', 'charge' => 65, 'nbSeries' => 4, 'ordre' => '1'],
                ['libelle' => 'Leg extensions', 'charge' => 60, 'nbSeries' => 4, 'ordre' => '2'],
                ['libelle' => 'RDL', 'charge' => 67.5, 'nbSeries' => 4, 'ordre' => '3'],
                ['libelle' => 'Extensions mollets', 'charge' => 130, 'nbSeries' => 4, 'ordre' => '4'],
            ]
        ];
